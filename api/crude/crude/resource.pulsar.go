...
func (x *fastReflection_Resource) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "crude.crude.Resource.title":
		return x.Title != ""
	case "crude.crude.Resource.body":
		return x.Body != ""
	case "crude.crude.Resource.creator":
		return x.Creator != ""
	case "crude.crude.Resource.category":
...
func (x *fastReflection_Resource) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "crude.crude.Resource.title":
		panic(fmt.Errorf("field title of message crude.crude.Resource is not mutable"))
	case "crude.crude.Resource.body":
		panic(fmt.Errorf("field body of message crude.crude.Resource is not mutable"))
	case "crude.crude.Resource.creator":
		panic(fmt.Errorf("field creator of message crude.crude.Resource is not mutable"))
	case "crude.crude.Resource.category":
		panic(fmt.Errorf("field category of message crude.crude.Resource is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: crude.crude.Resource"))
		}
...
func (x *Resource) GetCategory() uint64 {
	if x != nil {
		return x.Category
	}
	return 0
...
var file_crude_crude_resource_proto_rawDesc = []byte{
	...
	0x75, 0x64, 0x65, 0x2e, 0x63, 0x72, 0x75, 0x64, 0x65, 0x22, 0x7a, 0x0a, 0x08, 0x52, 0x65, 0x73,
	...
	,
}
